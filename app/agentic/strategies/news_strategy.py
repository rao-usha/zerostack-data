            ...
            for query in queries[:2]:  # Limit queries
                ...
                for result_div in soup.find_all('div', class_='result'):
                    ...
                    if title_elem:
                        ...
                        skip_domains = ['linkedin.com', 'facebook.com', 'twitter.com', 'sec.gov']
                    ...
                    for inv in investments:
                        if inv.get('company_name'):
                            companies.append({
                                ...
                                "investment_amount_usd": str(inv['investment_amount_usd']) if inv.get('investment_amount_usd') else None,
