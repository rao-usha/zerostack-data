...
class DataSynthesizer:
    ...
    def synthesize_findings(
        self, all_findings: List[Dict[str, Any]], investor_id: int, investor_type: str
    ) -> List[Dict[str, Any]]:
        """
    ...
    def merge_records(
        ...
        if source1 != source2 and priority1 > 0 and priority2 > 0:
            ...
            merged["agent_reasoning"] = (
                f"Confirmed by multiple sources: {source1}, {source2}"
            )
    ...
    def classify_investment_themes(
        self, companies: List[Dict[str, Any]], investor_id: int, investor_type: str
    ) -> List[Dict[str, Any]]:
        """
