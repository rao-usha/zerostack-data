...
class StartHuntRequest(BaseModel):
    ...
    entity_type: Optional[str] = Field(None, description="Filter by entity type (company)")
    ...
    min_priority: float = Field(0.0, ge=0.0, le=1.0, description="Minimum priority score")
