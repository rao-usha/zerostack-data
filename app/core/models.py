...
# =============================================================================
# DQ RECOMMENDATION MODEL
# =============================================================================


class RecommendationCategory(str, enum.Enum):
    """Categories for DQ recommendations."""
...
class DQRecommendation(Base):
    """
    Persisted data quality recommendations.

    Generated by the recommendation engine after analyzing DQ signals
    (profiling, anomalies, rule violations, job history, freshness).
    """

    __tablename__ = "dq_recommendations"

    id = Column(Integer, primary_key=True, autoincrement=True)
    category = Column(
        Enum(RecommendationCategory), nullable=False, index=True
    )
    priority = Column(
        Enum(RecommendationPriority), nullable=False, index=True
    )
    ...
    fix_action = Column(String(100), nullable=True)
    fix_params = Column(JSON, nullable=True)
    status = Column(
    ...
    def __repr__(self) -> str:
        return (
            f"<DQRecommendation(id={self.id}, priority='{self.priority}', "
