...
app.include_router(pe_firms.router, prefix="/api/v1")
...
app.include_router(people_dedup.router, prefix="/api/v1")
app.include_router(people_jobs.router, prefix="/api/v1")

# Site Intelligence Platform
app.include_router(site_intel_power.router, prefix="/api/v1")
app.include_router(site_intel_telecom.router, prefix="/api/v1")
app.include_router(site_intel_transport.router, prefix="/api/v1")
app.include_router(site_intel_labor.router, prefix="/api/v1")
app.include_router(site_intel_risk.router, prefix="/api/v1")
