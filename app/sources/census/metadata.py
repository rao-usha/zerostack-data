...
SQL_RESERVED_KEYWORDS = {
    "user", "table", "column", "select", "from", "where", "order", "group",
    "by", "having", "limit", "offset", "join", "inner", "outer", "left",
    "right", "on", "as", "and", "or", "not", "null", "default", "primary",
    "foreign", "key", "unique", "index", "constraint", "create", "drop",
    "alter", "truncate", "insert", "update", "delete", "grant", "revoke"
}
