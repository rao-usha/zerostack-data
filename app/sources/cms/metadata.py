...
DATASETS = {
    "medicare_utilization": {
        ...
        "columns": {
            ...
            "rndrng_prvdr_last_org_name": {"type": "TEXT", "description": "Provider Last Name/Organization Name"},
            "rndrng_prvdr_first_name": {"type": "TEXT", "description": "Provider First Name"},
            "rndrng_prvdr_mi": {"type": "TEXT", "description": "Provider Middle Initial"},
            "rndrng_prvdr_crdntls": {"type": "TEXT", "description": "Provider Credentials"},
            "rndrng_prvdr_gndr": {"type": "TEXT", "description": "Provider Gender"},
            "rndrng_prvdr_ent_cd": {"type": "TEXT", "description": "Provider Entity Type Code"},
            "rndrng_prvdr_st1": {"type": "TEXT", "description": "Provider Street Address 1"},
            "rndrng_prvdr_st2": {"type": "TEXT", "description": "Provider Street Address 2"},
            "rndrng_prvdr_city": {"type": "TEXT", "description": "Provider City"},
            "rndrng_prvdr_state_abrvtn": {"type": "TEXT", "description": "Provider State"},
            "rndrng_prvdr_state_fips": {"type": "TEXT", "description": "Provider State FIPS Code"},
            "rndrng_prvdr_zip5": {"type": "TEXT", "description": "Provider ZIP Code"},
            "rndrng_prvdr_ruca": {"type": "TEXT", "description": "Provider Rural-Urban Commuting Area Code"},
            "rndrng_prvdr_ruca_desc": {"type": "TEXT", "description": "Provider RUCA Description"},
            "rndrng_prvdr_cntry": {"type": "TEXT", "description": "Provider Country"},
            "rndrng_prvdr_type": {"type": "TEXT", "description": "Provider Type"},
            "rndrng_prvdr_mdcr_prtcptg_ind": {"type": "TEXT", "description": "Medicare Participation Indicator"},
            ...
            "tot_benes": {"type": "INTEGER", "description": "Total Number of Medicare Beneficiaries"},
            "tot_srvcs": {"type": "NUMERIC", "description": "Total Number of Services"},
            "tot_bene_day_srvcs": {"type": "INTEGER", "description": "Total Beneficiary Day Services"},
            "avg_sbmtd_chrg": {"type": "NUMERIC", "description": "Average Submitted Charge Amount"},
            "avg_mdcr_alowd_amt": {"type": "NUMERIC", "description": "Average Medicare Allowed Amount"},
            "avg_mdcr_pymt_amt": {"type": "NUMERIC", "description": "Average Medicare Payment Amount"},
            "avg_mdcr_stdzd_amt": {"type": "NUMERIC", "description": "Average Medicare Standardized Amount"},
        }
    },
    "hospital_cost_reports": {
        ...
        "columns": {
            ...
            "prvdr_ctrl_type_cd": {"type": "TEXT", "description": "Provider Control Type Code"},
            ...
            "adr_vndr_cd": {"type": "TEXT", "description": "Automated Desk Review Vendor Code"},
            "fi_creat_dt": {"type": "DATE", "description": "FI Create Date"},
            "util_cd": {"type": "TEXT", "description": "Utilization Code"},
            "npr_dt": {"type": "DATE", "description": "Notice of Program Reimbursement Date"},
    ...
    "drug_pricing": {
        ...
        "columns": {
            ...
            "unit_cnt_per_clm": {"type": "NUMERIC", "description": "Unit Count Per Claim"},
            "spndng_per_dsg_unt": {"type": "NUMERIC", "description": "Spending Per Dosage Unit"},
            "spndng_per_clm": {"type": "NUMERIC", "description": "Spending Per Claim"},
            "spndng_per_bene": {"type": "NUMERIC", "description": "Spending Per Beneficiary"},
...
"""
    ...
    if dataset_type == "medicare_utilization":
        ...
        sql += f"CREATE INDEX IF NOT EXISTS idx_{table_name}_npi ON {table_name}(npi);\n"
        ...
        sql += f"CREATE INDEX IF NOT EXISTS idx_{table_name}_year ON {table_name}(year);\n"
