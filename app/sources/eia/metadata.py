...
def generate_create_table_sql(table_name: str, category: str) -> str:
    """
...
def parse_eia_response(response: Dict[str, Any], category: str) -> List[Dict[str, Any]]:
    """
...
def parse_eia_record(record: Dict[str, Any], category: str) -> Optional[Dict[str, Any]]:
    """
...
def build_insert_values(parsed_records: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """
