...
def parse_worldbank_indicators(
    data: List[Dict[str, Any]]
) -> List[Dict[str, Any]]:
    """
    ...
    for item in data:
        ...
        try:
            ...
            record = {
                ...
                "country_code": item.get("ref_area") or item.get("location") or item.get("country"),
                
                # Indicator code from measure or subject
                "indicator_code": item.get("measure") or item.get("subject") or item.get("indicator"),
                ...
                # Time period
                "period": item.get("period") or item.get("time_period") or item.get("time"),
...
def build_insert_values(
    ...
    column_sets = {
        "worldbank_wdi": [
            ...
            "country_iso3", "region", "income_level", "year", "value",
            "unit", "decimal_places"
        ],
        "worldbank_countries": [
        ...
        "imf_ifs": [
            ...
            "period", "frequency", "value", "unit_mult", "status"
        ],
        "oecd_mei": [
            "indicator_code", "indicator_name", "country_code", "country_name",
            "subject", "measure", "frequency", "period", "value", "unit", "powercode"
        ],
        "bis_eer": [
            "country_code", "country_name", "eer_type", "basket",
            "period", "frequency", "value"
        ],
        "bis_property": [
            "country_code", "country_name", "property_type", "unit_measure",
            "period", "frequency", "value"
        ]
    }
