...
def generate_table_name(table_type: str) -> str:
    ...
    if table_type not in valid_types:
        raise ValueError(
            f"Invalid table type: {table_type}. Must be one of {valid_types}"
        )
...
M5_CALENDAR_SCHEMA = {
    ...
    "columns": [
        ...
        {"name": "date", "type": "DATE", "nullable": False, "pk": True},
        {
            ...
            "type": "VARCHAR(10)",
            "nullable": False,
            "description": "Day identifier (d_1 to d_1969)",
        },
        # Time dimensions
        {
            "name": "wm_yr_wk",
        ...
        # SNAP (food stamp) indicators by state
        {
            ...
            "type": "INTEGER",
            "nullable": False,
            "description": "SNAP day for California (0/1)",
        },
        {
            "name": "snap_tx",
            "type": "INTEGER",
            "nullable": False,
            "description": "SNAP day for Texas (0/1)",
        },
        {
            "name": "snap_wi",
            "type": "INTEGER",
            "nullable": False,
            "description": "SNAP day for Wisconsin (0/1)",
        },
        # Metadata
        {
            "name": "ingested_at",
...
M5_ITEMS_SCHEMA = {
    ...
    "columns": [
        # Primary key - unique combination of item and store
        {
            ...
            "nullable": False,
            "pk": True,
            "description": "Unique ID (item_id + store_id)",
        },
        # Item identification
        {"name": "item_id", "type": "VARCHAR(30)", "nullable": False},
        # Hierarchy
        {
            ...
            "type": "VARCHAR(20)",
            "nullable": False,
            "description": "Department (e.g., FOODS_1)",
        },
        {
            "name": "cat_id",
            "type": "VARCHAR(20)",
            "nullable": False,
            "description": "Category (FOODS, HOBBIES, HOUSEHOLD)",
        },
        {
            "name": "store_id",
            "type": "VARCHAR(10)",
            "nullable": False,
            "description": "Store (e.g., CA_1)",
        },
        {
            "name": "state_id",
            "type": "VARCHAR(5)",
    ...
    "indexes": [
        ...
        {
            "name": "idx_m5_items_hierarchy",
            "columns": ["state_id", "store_id", "cat_id", "dept_id"],
        },
    ],
}
...
M5_SALES_SCHEMA = {
    ...
    "columns": [
        # Foreign keys / identifiers
        {
            ...
            "type": "VARCHAR(50)",
            "nullable": False,
            "description": "FK to m5_items.id",
        },
        {
            "name": "d",
            "type": "VARCHAR(10)",
            "nullable": False,
            "description": "Day identifier (FK to m5_calendar.d)",
        },
        ...
        {"name": "store_id", "type": "VARCHAR(10)", "nullable": False},
        {
            ...
            "type": "DATE",
            "nullable": True,
            "description": "Actual date (can be joined from calendar)",
        },
        # Sales value
        {
            "name": "sales",
            "type": "INTEGER",
            "nullable": False,
            "description": "Unit sales for the day",
        },
        # Metadata
        {
            "name": "ingested_at",
