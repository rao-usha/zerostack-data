"""
Base collector class for LP data collection.
...
class BaseCollector(ABC):
    """
    Abstract base class for LP data collectors.
    ...
    USER_AGENT = "Nexdata-LP-Collector/1.0 (Data Research; contact@nexdata.io)"
    ...
    async def collect(
        ...
        **kwargs,
        ...
        Args:
            ...
            website_url: LP website URL (if applicable)
            **kwargs: Additional source-specific parameters

        Returns:
            CollectionResult with collected items or error
        """
        pass
    ...
    def _create_result(
        ...
        lp_name: str,
        success: bool = False,
        items: Optional[List[CollectedItem]] = None,
        error_message: Optional[str] = None,
        warnings: Optional[List[str]] = None,
        started_at: Optional[datetime] = None,
    ) -> CollectionResult:
        """
        Create a CollectionResult with current tracking data.
        ...
        Returns:
            CollectionResult populated with tracking data
        """
