...
PECollectionOrchestrator.register_collector(
    PECollectionSource.FIRM_WEBSITE, FirmWebsiteCollector
)
PECollectionOrchestrator.register_collector(
    PECollectionSource.SEC_FORM_D, SECFormDCollector
)
PECollectionOrchestrator.register_collector(PECollectionSource.SEC_13D, SEC13FCollector)
PECollectionOrchestrator.register_collector(
    PECollectionSource.PUBLIC_COMPS, PublicCompsCollector
)
PECollectionOrchestrator.register_collector(
    PECollectionSource.PRESS_RELEASE, PressReleaseCollector
)
PECollectionOrchestrator.register_collector(
    PECollectionSource.BIO_EXTRACTOR, BioExtractor
)
PECollectionOrchestrator.register_collector(
    PECollectionSource.NEWS_API, PENewsCollector
)
PECollectionOrchestrator.register_collector(
    PECollectionSource.VALUATION_ESTIMATOR, ValuationEstimator
)
