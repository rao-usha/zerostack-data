"""
Base collector class for PE data collection.
...
class BasePECollector(ABC):
    """
    Abstract base class for PE data collectors.

    Subclasses must implement:
    - source_type: The collection source type
    - entity_type: The type of entity this collector handles
    ...
    def __init__(
        ...
        """
        self.rate_limit_delay = rate_limit_delay or settings.default_rate_limit_delay
    ...
    def entity_type(self) -> EntityType:
        """The entity type this collector handles."""
        pass
    ...
    async def collect(
        ...
        **kwargs,
        ...
        Args:
            entity_id: Entity ID (firm_id, company_id, etc.)
            entity_name: Entity name
            website_url: Entity website URL (if applicable)
            **kwargs: Additional source-specific parameters

        Returns:
            PECollectionResult with collected items or error
        """
        pass
                ...
                async with httpx.AsyncClient(
                    ...
                    if method.upper() == "GET":
                        ...
                        response = await client.post(
                            url, headers=default_headers, params=params, json=json_body
                        )
                    else:
    ...
    def _create_result(
        ...
        entity_name: str,
        success: bool = False,
        items: Optional[List[PECollectedItem]] = None,
        error_message: Optional[str] = None,
        warnings: Optional[List[str]] = None,
        started_at: Optional[datetime] = None,
    ) -> PECollectionResult:
        """
        Create a PECollectionResult with current tracking data.
        ...
        Returns:
            PECollectionResult populated with tracking data
        """
    ...
    def _create_item(
        ...
        Args:
            item_type: Type of item (firm, fund, company, person, etc.)
            data: The collected data
            source_url: Source URL
            confidence: Confidence level
            is_new: Whether item is new
