...
def validate_email(email: Optional[str]) -> Tuple[bool, Optional[str]]:
    ...
    generic_prefixes = ['info', 'contact', 'admin', 'webmaster', 'sales', 'support', 'hello']
...
def is_institutional_email(email: str) -> bool:
    ...
    institutional_indicators = [
        '.gov', '.edu', '.org',  # Government, education, org TLDs
        'pension', 'invest', 'capital', 'treasury', 'endowment',  # Keywords
...
def validate_name(name: Optional[str]) -> Tuple[bool, Optional[str]]:
    ...
    generic_terms = [
        'office', 'department', 'team', 'group', 'division', 'unit',
        'desk', 'center', 'centre', 'bureau'
    ]
    
    # Allow specific generic contacts
    allowed_generic = [
        'media relations', 'investor relations', 'investment office',
...
def is_generic_contact(name: str) -> bool:
    ...
    generic_indicators = [
        'office', 'relations', 'media', 'communications', 'contact',
        'department', 'team', 'inquiry', 'inquiries'
    ]
