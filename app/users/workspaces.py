...
class WorkspaceService:
    ...
    def _check_permission(self, workspace_id: int, user_id: int, required_role: str = "viewer") -> bool:
        ...
        if not row:
            ...
            owner_result = self.db.execute(text("""
    ...
    def create_workspace(self, owner_id: int, name: str, description: Optional[str] = None) -> Dict[str, Any]:
    ...
    def update_workspace(self, workspace_id: int, user_id: int, updates: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        query = f"UPDATE workspaces SET {', '.join(set_clauses)} WHERE id = :workspace_id"
    ...
    def invite_member(self, workspace_id: int, inviter_id: int, email: str, role: str = "member") -> Dict[str, Any]:
        ...
        member_check = self.db.execute(text("""
    ...
    def get_pending_invitations(self, workspace_id: int, user_id: int) -> List[Dict[str, Any]]:
    ...
    def update_member_role(self, workspace_id: int, admin_id: int, user_id: int, new_role: str) -> bool:
